...
const PORT = process.env.SHAMIR_SERVER_1_PORT;

const pool = new Pool({ connectionString: process.env.SHAMIR_DB_1 });
...
app.listen(PORT, () => {
    ...
    console.log(`Shamir_1 server running on PORT: ${PORT}`)
