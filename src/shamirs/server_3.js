...
const PORT = process.env.SHAMIR_SERVER_3_PORT;

const pool = new Pool({ connectionString: process.env.SHAMIR_DB_3 });
...
app.listen(PORT, () => {
    ...
    console.log(`Shamir_3 server running on PORT: ${PORT}`)
